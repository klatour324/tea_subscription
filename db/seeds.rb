...
subscription5 = FactoryBot.create(:subscription, customer_id: customers[2].id, tea_id: teas[2].id)
...
subscription10 = FactoryBot.create(:subscription, customer_id: customers[4], tea_id: teas[0].id)
